    ...
    <div class="carousel-inner">
      <div class="carousel-item active">
       ...
       <div class="carousel-caption custom-caption">
          ...
          <p class="cap-write">Sed autem laudantium dolores. Voluptatem itaque ea consequatur eveniet. Eum quas beatae cumque eum
            quaerat.</p>
          <div class="d-flex">
            <a href="form.php" class="btn-get-started">Submit your proposal</a>
      ...
      <div class="carousel-item">
        ...
        <div class="carousel-caption custom-caption">
          ...
          <div class="d-flex">
            <a href="../about.php" class="btn-get-started">About Us </a>
            <a href="https://www.youtube.com/watch?v=Y7f98aduVJ8"
              class="glightbox btn-watch-video d-flex align-items-center">
              <i class="bi bi-play-circle"></i><span>Watch Video</span>
            </a>
      ...
      <div class="carousel-item">
        ...
        <div class="carousel-caption custom-caption">
          ...
          <div class="d-flex">
            <a href="/form.php" class="btn-get-started">Apply Now</a>
            <a href="https://www.youtube.com/watch?v=Y7f98aduVJ8"
              class="glightbox btn-watch-video d-flex align-items-center">
              <i class="bi bi-play-circle"></i><span>Watch Video</span>
            </a>
